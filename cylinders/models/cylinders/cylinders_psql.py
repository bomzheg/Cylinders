...
class CylindersPostgresModel(CylindersBaseModel):
    SQL_CYLINDERS = """
        ...
        WHERE "СоотношениеОбъёмов".show = true or "Баллоны в партиях"."Количество" is not null
        ORDER BY ("СоотношениеОбъёмов"."order_", "СоотношениеОбъёмов"."Давление, ат", "СоотношениеОбъёмов"."Колличество в связке", "СоотношениеОбъёмов"."Объём баллона, л")
